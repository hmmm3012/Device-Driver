...
#else
static struct file_operations file_ops_our_proc_file =
    {
        .proc_read = procfs_read,
        .proc_write = procfs_write,
        .proc_open = procfs_open,
...
static int __init procfs_init(void) {
  our_proc_file =
      proc_create(PROCFS_ENTRY_FILENAME, 0666, NULL, &file_ops_our_proc_file);
...
MODULE_DESCRIPTION("A module that creates entries in /proc");
